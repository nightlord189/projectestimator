class FinalModel:
    ...
    # 0 - Generic, 1 - Js, 2 - Go, 3 - Python, 4 - Java-like, 5 - C#, 6 - C++, 7 - C, 8 - Delphi/Pascal
    Language =0
    #project team
    ...
    Team=0.0
    SizeMetric=0 #Unknown - 0, LOC-1, Function points - 2, UseCasePoints - 3
    Size=0 #size in {SizeMetric} units
    DevelopmentMode=0 #0 - new project, 1 - rework
    CodeReuse=0.0 # - code reuse percentage (from 0 to 1.0)
    Architecture=0 #0 - generic, 1 - level, 2 - event-drive, 3 - microcore, 4 - microservices
